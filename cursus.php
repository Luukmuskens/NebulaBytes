...
<body style="margin-bottom:200px">
    ...
    <div id="content">
        <div id="bg" class=" ">
            ...
            <h1>Het is meer dan een cursus</h1>
            <p>het is echt een community!</p>
            <p> - Diepgaande video's over Risk Management

                - Diepgaande video's over Technische Analyse

                - Fundamentele Analyse (Gebaseerd op basis van de financiële cijfers en prestaties)

                - Video's over hoe je mindset moet zijn tijdens het traden.</p>
    ...
    <div class="row text-center" id="watch">
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/cursussen.png" alt="" class="img-fluid pb-1" >
                <div class="figure-caption">
                    <h6>Cursus beginner</h6>
                    <h6>Prijs :150 euro</h6>
        ...
        <div class="col-md-3 col-6 py-2">
            <div class="card">
                <img src="images/cursussen.png" alt="" class="img-fluid pb-1">
                <div class="figure-caption">
                    <h6>Cursus ervaren</h6>
                    <h6>Prijs :300 euro</h6>
                    <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
